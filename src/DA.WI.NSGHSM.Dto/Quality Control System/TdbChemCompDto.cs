...
namespace DA.WI.NSGHSM.Dto.QualityControlSystem
{
    ...
    public class TdbChemCompBaseDto
    {
    ...
    public class TdbChemCompDto : TdbChemCompBaseDto
    {
    }

    public class TdbChemCompListItemDto : TdbChemCompDto
    {
    }

    public class TdbChemCompForInsertDto : TdbChemCompBaseDto
    {
    }

    public class TdbChemCompForUpdateDto : TdbChemCompBaseDto
    {
    }

    public class TdbChemCompDetailDto : TdbChemCompDto
    {
    }

    public class TdbChemCompListFilterDto
    {
    }
}