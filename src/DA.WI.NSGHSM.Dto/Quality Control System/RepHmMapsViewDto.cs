...
namespace DA.WI.NSGHSM.Dto.QualityControlSystem
{
    ...
    [DataContract]
    public class RepHmMapsViewBaseDto
    {
         [DataMember]
    ...
    public class RepHmMapsViewDto : RepHmMapsViewBaseDto
    {
    }

    public class RepHmMapsViewListItemDto : RepHmMapsViewDto
    {
    }

    public class RepHmMapsViewDetailDto
    {
        public int MillMode { get; set; }
        public int OutPieceNo { get; set; }
    }

     public class RepHmMapsViewListFilterDto
    {
