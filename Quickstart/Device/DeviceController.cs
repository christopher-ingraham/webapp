...
namespace IdentityServer4.Quickstart.UI.Device
{
    ...
    public class DeviceController : Controller
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(userCode) == true)
        ...
        private async Task<ProcessConsentResult> ProcessConsent(DeviceAuthorizationInputModel model)
        {
            ...
            else if (model.Button == "yes")
            {
                ...
                if ((model.ScopesConsented != null) && (model.ScopesConsented.Any() == true))
                {
        ...
        private async Task<DeviceAuthorizationViewModel> BuildViewModelAsync(string userCode, DeviceAuthorizationInputModel model = null)
        {
            ...
            if (request != null)
            {
                ...
                if (client != null)
                {
                    ...
                    if ((resources != null) && ((resources.IdentityResources.Any() == true) || (resources.ApiResources.Any() == true)))
                    {
        ...
        private DeviceAuthorizationViewModel CreateConsentViewModel(string userCode, DeviceAuthorizationInputModel model, Client client, Resources resources)
        {
            ...
            vm.IdentityScopes = resources.IdentityResources.Select(x => CreateScopeViewModel(x, (vm.ScopesConsented.Contains(x.Name) == true) || (model == null))).ToArray();
            vm.ResourceScopes = resources.ApiResources.SelectMany(x => x.Scopes).Select(x => CreateScopeViewModel(x, (vm.ScopesConsented.Contains(x.Name) == true) || (model == null))).ToArray();
            if ((ConsentOptions.EnableOfflineAccess == true) && (resources.OfflineAccess == true))
            {
                vm.ResourceScopes = vm.ResourceScopes.Union(new[]
                {
                    GetOfflineAccessScope((vm.ScopesConsented.Contains(IdentityServerConstants.StandardScopes.OfflineAccess) == true) || (model == null))
                });
            }
        ...
        private ScopeViewModel CreateScopeViewModel(IdentityResource identity, bool check)
        {
            return new ScopeViewModel
            {
                ...
                Checked = (check == true) || (identity.Required == true)
            };
        }
        ...
        public ScopeViewModel CreateScopeViewModel(Scope scope, bool check)
        {
            return new ScopeViewModel
            {
                ...
                Checked = (check == true) || (scope.Required == true)
            };
        }
